...
struct FindDeleteSearchService {
    static let shared = FindDeleteSearchService()
    
    func delete(id: Int,completion : @escaping (NetworkResult<Any>) -> (Void)) {
        let url = APIConstants.searchDeleteURL+String(id)
