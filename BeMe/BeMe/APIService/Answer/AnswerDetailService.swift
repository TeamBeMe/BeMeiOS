...
struct AnswerDetailService {
    static let shared = AnswerDetailService()
    
    func getAnswerDetail(answerId: Int, completion: @escaping (NetworkResult<Any>) -> Void) {
        ...
        let url = APIConstants.explorationDetailAnswerURL + "/\(answerId)"
